...
public class UpdatedDropdown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// TODO Auto-generated method stub
				...
				System.out.println("Before executing a loop: " + driver.findElement(By.id("divpaxinfo")).getText());
				...
				System.out.println("After executing a loop: " + driver.findElement(By.id("divpaxinfo")).getText());
			}
	}
