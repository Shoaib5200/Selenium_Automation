...
public class End_To_End_AutomationWebPage {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Insert text in the Suggestive Dropdown
		...
		// CLick the Round Trip and verify that return date (section) is Enabled or Disabled
		System.out.println(driver.findElement(By.id("Div1")).getAttribute("style"));
		//driver.findElement(By.cssSelector("input[id='ctl00_mainContent_rbtnl_Trip_1']")).click();
		System.out.println(driver.findElement(By.id("Div1")).getAttribute("style"));
		if(driver.findElement(By.id("Div1")).getAttribute("style").contains("0.5")) {
			System.out.println("It's disbaled");
			Assert.assertTrue(true);
		}else {
			Assert.assertTrue(false);
		}
		
		// Get Passengers from increamental dropdown
